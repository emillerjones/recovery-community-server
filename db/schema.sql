...
-- Store only coarse usage facts. Raw IP addresses and private content are not
-- persisted. Deleting a user keeps aggregate history but removes its identity.
